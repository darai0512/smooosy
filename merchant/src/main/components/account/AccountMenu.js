...
export default class AccountMenu extends React.Component {
  render() {
    ...
    const proMenus = [
      { value: 'services', label: 'スケジュール', link: '/account/services' },
      { value: 'profiles', label: '事業者プロフィール', link: '/account/profiles' },
      { value: 'reviews', label: 'クチコミ', link: '/account/reviews' },
      { value: 'templates', label: '募集定型文', link: '/account/templates' },
      { value: 'referrals', label: '他の事業者を紹介', link: '/account/referrals' },
